...
\title{Division, fractions, and irrational numbers}
\author{Jenny Sheldon}

\begin{document}

\begin{abstract}
We build to the idea of irrational numbers..
\end{abstract}
\maketitle

\section{Activities for this section:} 
\link[Fractions and division]{https://ximera.osu.edu/m4t/elementaryActivities/SemesterOnePacket/elementaryActivities/Division/FractionsAndDivision}
...
\section{Types of decimal numbers}


Recall that in \link[Fractions and decimals]{https://ximera.osu.edu/m4t/elementaryTeachersOne/elementaryReading/Numbers/FractionsDecimals}, we used the fact that $0.1 = \frac{1}{10}$ to write the decimal equivalents for fractions like $\frac{3}{20}$ or $\frac{6}{8}$.  We noticed that if we can make an equivalent fraction whose denominator is a power of $10$ (like $10$, $100$, $1000$, etc), we can write the fraction as a decimal by looking at the numerator of that fraction. Decimals like this one, which can be written as a fraction whose denominator is a power of $10$ and whose decimal values stop at some place value, are called \dfn{terminating decimals}. 
